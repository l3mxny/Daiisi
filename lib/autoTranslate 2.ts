...
const OVERRIDES: Record<TargetLanguage, Record<string, string>> = {
  sw: {
    ...
    Results: "Matokeo",
    "Farmer's text": "Ujumbe wa mkulima",
  ...
  fr: {
    ...
    Results: "Résultats",
    "Farmer's text": "SMS de l'agriculteur",
  ...
  es: {
    ...
    Results: "Resultados",
    "Farmer's text": "Mensaje al agricultor",
  ...
  pt: {
    ...
    Results: "Resultados",
    "Farmer's text": "Mensagem ao agricultor",
